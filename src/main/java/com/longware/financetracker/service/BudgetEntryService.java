...
public class BudgetEntryService {
    ...
    public Page<BudgetEntry> findAllByUserAccount(UserAccount userAccount, Pageable pageable) {
        return budgetEntryRepository.findPageByUserAccount(userAccount, pageable);
    }
