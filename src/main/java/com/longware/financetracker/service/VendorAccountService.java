...
public class VendorAccountService {
    ...
    public Page<VendorAccount> findAllByUserAccount(UserAccount userAccount, Pageable pageable) {
        return vendorAccountRepository.findPageByUserAccount(userAccount, pageable);
    }
