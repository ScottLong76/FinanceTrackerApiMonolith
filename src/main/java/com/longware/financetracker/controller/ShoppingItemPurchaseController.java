...
public class ShoppingItemPurchaseController {
    ...
    public ShoppingItemPurchase getShoppingItemPurchaseById(Long id) {
    ...
    public Iterable<ShoppingItemPurchase> getAllShoppingItemPurchases() {
    ...
    public void deleteShoppingItemPurchase(ShoppingItemPurchase shoppingItemPurchase) {
